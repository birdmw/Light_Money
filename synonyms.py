...
def do_pac_synonyms2(donor_synonym_dict):
    ...
    donor_synonym_dict = add_synonyms(donor_synonym_dict, ['17TH LEG DIST REPUB COMM NON EXEMPT',
                                                           '43RD DIST REPUB PARTY EXEMPT',
                                                           '7TH DIST REPUB COMM',
                                                           '43RD DIST REPUB PARTY NON EXEMPT',
                                                           '45TH LEG DIST REPUB NON EXEMPT',
    ...
    donor_synonym_dict = add_synonyms(donor_synonym_dict, ['NEW DIRECTION PAC', 'NEW DIRECTION'])
